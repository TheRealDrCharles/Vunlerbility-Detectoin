...
class PLSTM_python_net(nn.Module):
    def __init__(self, weights):
        super(PLSTM_python_net, self).__init__()
...
class PLSTM_python_Feature_Net(nn.Module):
    def __init__(self, net, weights):
        super(PLSTM_python_Feature_Net, self).__init__()
